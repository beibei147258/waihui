...
$codepay_config['return_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/codepay/return.php';    //    $codepay_config['path'] . '/return.php'; //自动生成跳转地址


$codepay_config['notify_url'] ='http://'.$_SERVER['HTTP_HOST'].'/codepay/notify.php'  ;   // $codepay_config['path'] . '/notify.php'; //自动生成通知地址 优先级最高不传入则为系统设置里设置

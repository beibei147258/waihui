...
//     '            <a href="https://chatlink.mstatik.com/widget/standalone.html?eid=236591">\n' +
//     '                <img src="/Public/images/kefu.png?v=1.2" alt="客服" style="width: 40px; height: 40px;">\n' +
//     '            </a>\n' +
//     '        </div>';

var kefu_html = '<div class="kefu" style="position: absolute; top: 20px; right: 5px; z-index: 9999;">\n' +
    '            <a href="/customlivechat/php/app.php?widget-mobile">\n' +
    '                <img src="/Public/images/kefu.png?v=1.2" alt="客服" style="width: 40px; height: 40px;">\n' +
    '            </a>\n' +
    '        </div>';
